const I = {
	...
	coin: 'M8 14a6 6 0 100-12 6 6 0 000 12zM10.5 5.5c-.5-.6-1.3-1-2.4-1-1.4 0-2.3.6-2.3 1.6 0 2.4 4.6 1.1 4.6 3.5 0 1.1-1 1.9-2.5 1.9-1.1 0-2-.4-2.6-1M8 3.5v1M8 11.5v1',
	...
	heart: 'M8 13s-5-3-5-6a2.8 2.8 0 015-1.7A2.8 2.8 0 0113 7c0 3-5 6-5 6z',
	globe: 'M8 14a6 6 0 100-12 6 6 0 000 12zM2.5 8h11M8 2c1.5 1.6 2.2 3.6 2.2 6S9.5 12.4 8 14M8 2C6.5 3.6 5.8 5.6 5.8 8S6.5 12.4 8 14',
	thumbsUp: 'M5.5 7.5l2-5a1 1 0 011.8.8L9 6h3.5a1 1 0 011 1.2l-.9 5a1 1 0 01-1 .8H5.5zM2.5 7h3v6h-3z',
...
export default function Icon({ name, className = '', size = 14, strokeWidth = 1.6, style }) {
	const d = I[name]
	if (!d) return null
	return (
		<svg
