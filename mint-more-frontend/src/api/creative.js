...
export const creativeApi = {
  ...
  designerSocialQueue: () => api.get('/creative/designer/social-queue'),
  uploadCreativeToSocialPost: (postId, payload) => api.patch(`/creative/designer/social-queue/${postId}/upload`, payload),
